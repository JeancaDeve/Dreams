...
public class User extends BaseEntity {
    ...
    // ! Solo especificamos el nombre de la columna cuando usamos 'camelCase' a "snake_case"
    ...
    @Column(nullable = false, length = 9, columnDefinition = "char(9)", name = "phone_number") // ? un numero celular maximo es de 9 digitos
